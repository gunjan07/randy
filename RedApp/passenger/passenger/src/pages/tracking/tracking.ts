...
export class TrackingPage {
  ...
  constructor(public nav: NavController, public driverService: DriverService, public platform: Platform,
              public tripService: TripService, public placeService: PlaceService, public modalCtrl: ModalController,public chatservice: ChatProvider) {
  }
  ...
  // console.log("clciked driver uid");
   //console.log(this.driver.uid);
  // this.chatservice.initializebuddy(this.driver.uid);
  // this.nav.push('BuddychatPage');
   ...
   // this.nav.push(BuddychatPage,{receiverid:'VryDxpx7XYbJey8kXxIVkEE1UOp1'
    ...
    this.chatservice.initializebuddy(this.driver.$key);
    this.nav.push('BuddychatPage');
